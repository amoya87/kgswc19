...
In the end, we have 221 curated queries. An analysis of the basic use of SPARQL features was carried out counting the keywords in the queries (see Table~\ref{tab:Keyword}).
